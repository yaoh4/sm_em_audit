...
public class ReportsDAO {
	...
	public PaginatedListImpl<TransferredAuditAccountsVO> searchTransferredAccounts(PaginatedListImpl paginatedList, final AuditSearchVO searchVO, Boolean all) throws Exception {
		...
		try {		
			...
			i2eVwLeftJoinAuditVw.append("i2eVw.transfer_to_ned_org_path AS transferToNedOrgPath, i2eVw.transfer_from_ned_org_path AS transferFromNedOrgPath ");
			...
			i2eVwLeftJoinAuditVw.append("where i2eVw.audit_id = :auditId and i2eVw.transfer_to_ned_org_path is not null ");			
			...
			auditVwLeftJoinI2eVw.append("auditVw.transfer_to_ned_org_path AS transferToNedOrgPath, auditVw.transfer_from_ned_org_path AS transferFromNedOrgPath ");
			...
			auditVwLeftJoinI2eVw.append("where auditVw.audit_id = :auditId and auditVw.transfer_to_ned_org_path is not null ");
			
			transferredAccountsQuery.append("select lastName, firstName, nihNetworkId, nedOrgPath, impaciiActiveStatusFlag, i2eActiveStatusFlag, transferToNedOrgPath, transferFromNedOrgPath  from ( ")	;
