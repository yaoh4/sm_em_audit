...
/**
 * EmI2ePortfolioVw generated by hbm2java
 */
public class EmI2ePortfolioVw implements java.io.Serializable {
	...
	public EmI2ePortfolioVw() {
	}

	public EmI2ePortfolioVw(Long npnId, String i2eLastName, String i2eFirstName, Date createdDate) {
		this.npnId = npnId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EmI2ePortfolioVw))
			return false;
		EmI2ePortfolioVw castOther = (EmI2ePortfolioVw) other;
